...
export function toClashMeta(
  ...
  if (preset === 'ai') {
    ...
    extraRules.push(
      ...
      'DOMAIN-SUFFIX,oaistatsig.com,🤖 智算 AI',
      'DOMAIN,cdn.openaimerge.com,🤖 智算 AI',
      'DOMAIN-SUFFIX,anthropic.com,🤖 智算 AI',
      'DOMAIN-SUFFIX,claude.ai,🤖 智算 AI',
      'DOMAIN-SUFFIX,claude.com,🤖 智算 AI',
      'DOMAIN-SUFFIX,claudeusercontent.com,🤖 智算 AI',
      'DOMAIN-SUFFIX,claudemcpcontent.com,🤖 智算 AI',
      'DOMAIN-SUFFIX,claudemcpclient.com,🤖 智算 AI',
      'DOMAIN-SUFFIX,perplexity.ai,🤖 智算 AI',
      'DOMAIN-SUFFIX,githubcopilot.com,🤖 智算 AI',
      'DOMAIN,copilot-proxy.githubusercontent.com,🤖 智算 AI',
      'DOMAIN,origin-tracker.githubusercontent.com,🤖 智算 AI',
      'DOMAIN,copilot.microsoft.com,🤖 智算 AI',
      'DOMAIN,copilotprodattachments.blob.core.windows.net,🤖 智算 AI',
      'DOMAIN,copilot.cloud.microsoft,🤖 智算 AI',
      'DOMAIN-SUFFIX,groq.com,🤖 智算 AI',
      'DOMAIN-SUFFIX,antigravity.google,🤖 智算 AI',
      'DOMAIN-SUFFIX,antigravity-unleash.goog,🤖 智算 AI',
      'DOMAIN,antigravity-cli-auto-updater-974169037036.us-central1.run.app,🤖 智算 AI',
      'DOMAIN,daily-cloudcode-pa.googleapis.com,🤖 智算 AI',
      'DOMAIN,antigravity-pa.googleapis.com,🤖 智算 AI',
      'DOMAIN,antigravity.googleapis.com,🤖 智算 AI',
      'DOMAIN,gemini.google.com,🤖 智算 AI',
      'DOMAIN,aistudio.google.com,🤖 智算 AI',
      'DOMAIN,gemini.gstatic.com,🤖 智算 AI',
      'DOMAIN,alkalicore-pa.clients6.google.com,🤖 智算 AI',
      'DOMAIN,alkalimakersuite-pa.clients6.google.com,🤖 智算 AI',
      'DOMAIN,webchannel-alkalimakersuite-pa.clients6.google.com,🤖 智算 AI',
      'DOMAIN,cloudaicompanion.googleapis.com,🤖 智算 AI',
      'DOMAIN,generativelanguage.googleapis.com,🤖 智算 AI',
      'DOMAIN,cloudcode-pa.googleapis.com,🤖 智算 AI',
